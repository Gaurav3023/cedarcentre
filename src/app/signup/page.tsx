...
import { User, Mail, ShieldCheck, ArrowRight, Loader2, CheckCircle2, Lock, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-cedar-background py-20 px-8 flex items-center justify-center">
      ...
      >
        <div className="text-center mb-12 relative z-10">
          ...
          <p className="text-slate-500 mt-3 font-medium">Join the Cedar Centre STAIR Program today.</p>
        </div>
            ...
            <div>
              ...
              <div className="mt-2 relative">
                ...
                <input 
                  ...
                  className="input-field pl-14 pr-14" 
                />
                <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600">
