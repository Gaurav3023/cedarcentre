      ...
      <section className="max-w-7xl mx-auto px-8 pb-40">
        <div className="space-y-32">
           ...
           <ServiceDetail 
             ...
             desc="A specialized program for adults 19+ who have experienced interpersonal childhood trauma. The first phase focuses on STAIR Program Coaching (Skills Training in Affective and Interpersonal Regulation)."
             color="bg-purple-50"
             reverse
           />
