...
import { ShieldAlert, Lock, ArrowRight, Loader2, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-8">
      ...
      >
        <div className="flex flex-col items-center text-center mb-12">
          <Link href="/">
             <img src="https://cedarcentre.ca/wp-content/uploads/2023/07/cedar-logo1.svg" alt="Cedar Centre" className="h-20 mb-8" />
          </Link>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full px-6 py-5 bg-slate-800/50 border border-slate-700 rounded-2xl focus:ring-4 focus:ring-cedar-primary/20 focus:border-cedar-primary outline-none transition-all text-white font-medium pr-14"
                placeholder="••••••••"
              />
              <button
                type="button"
