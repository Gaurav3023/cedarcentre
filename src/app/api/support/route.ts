    ...
    try {
      ...
      if (student && educator) {
        ...
        await sendEmail({
          ...
          html: `
            <h2 style="color: #017196; margin-top: 0;">New Assistance Request</h2>
            <p>Hi ${educator.name},</p>
            <p><strong>${student.name}</strong> has started a new assistance request.</p>
            <div style="background-color: #f1f5f9; padding: 20px; border-radius: 12px; margin: 25px 0; border-left: 4px solid #017196;">
      ...
      try {
        ...
        if (recipient && sender) {
          ...
          await sendEmail({
            ...
            html: `
              <h2 style="color: #017196; margin-top: 0;">New Message Received</h2>
              <p>Hi ${recipient.name},</p>
              <p>You have received a new message from <strong>${sender.name}</strong> on the Cedar Centre STAIR Program Platform.</p>
              <div style="background-color: #f1f5f9; padding: 20px; border-radius: 12px; margin: 25px 0; border-left: 4px solid #017196;">
