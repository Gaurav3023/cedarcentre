  ...
  try {
    ...
    if (newUser.status === 'pending') {
      sendEmailBackground({
        ...
        html: `
          <h2 style="color: #017196; margin-top: 0;">Welcome, ${newUser.name}!</h2>
          <p>Thank you for signing up for the Cedar Centre STAIR Program.</p>
          <p>Your account has been created successfully and is currently pending approval.</p>
